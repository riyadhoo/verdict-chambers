  ...
  head: () => ({
    meta: [
      ...
      { title: "VERDICT — Multiplayer Jury Courtroom Game" },
      {
        name: "description",
        content:
          "Gather a jury of up to twelve, weigh the evidence and deliver a verdict in a live courtroom deduction game.",
      },
      { name: "author", content: "VERDICT" },
      { property: "og:title", content: "VERDICT — Multiplayer Jury Courtroom Game" },
      {
        property: "og:description",
        content: "A live multiplayer courtroom deduction game for up to twelve jurors.",
      },
